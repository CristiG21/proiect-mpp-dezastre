package com.mpp.disaster.config;

import static org.springframework.security.config.Customizer.withDefaults;
import static org.springframework.security.oauth2.core.oidc.StandardClaimNames.PREFERRED_USERNAME;

import com.mpp.disaster.security.*;
import com.mpp.disaster.security.SecurityUtils;
import com.mpp.disaster.security.oauth2.AudienceValidator;
import com.mpp.disaster.security.oauth2.CustomClaimConverter;
import com.mpp.disaster.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/centers/**")).permitAll()
                    .requestMatchers(mvc.pattern("/api/disasters/**")).permitAll()
                    .requestMatchers(mvc.pattern("/api/community-messages/**")).permitAll()
                    .requestMatchers(mvc.pattern("/api/official-messages/**")).permitAll()
