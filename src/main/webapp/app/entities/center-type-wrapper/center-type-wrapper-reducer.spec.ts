...
import reducer, {
  ...
  reset,
  updateEntity,
} from './center-type-wrapper.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENTERTYPEWRAPPER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CENTERTYPEWRAPPER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CENTERTYPEWRAPPER actions', async () => {
      const arg = { id: 19868 };
    ...
    it('dispatches UPDATE_CENTERTYPEWRAPPER actions', async () => {
      const arg = { id: 19868 };
    ...
    it('dispatches PARTIAL_UPDATE_CENTERTYPEWRAPPER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CENTERTYPEWRAPPER actions', async () => {
      const arg = 42666;
