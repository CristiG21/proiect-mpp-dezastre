...
import reducer, {
  ...
  reset,
  updateEntity,
} from './community-message.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMUNITYMESSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMUNITYMESSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMUNITYMESSAGE actions', async () => {
      const arg = { id: 1952 };
    ...
    it('dispatches UPDATE_COMMUNITYMESSAGE actions', async () => {
      const arg = { id: 1952 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMUNITYMESSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMUNITYMESSAGE actions', async () => {
      const arg = 42666;
