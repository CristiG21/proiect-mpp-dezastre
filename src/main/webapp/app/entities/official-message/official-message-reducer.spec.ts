...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFICIALMESSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OFFICIALMESSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OFFICIALMESSAGE actions', async () => {
      const arg = { id: 10766 };
    ...
    it('dispatches UPDATE_OFFICIALMESSAGE actions', async () => {
      const arg = { id: 10766 };
    ...
    it('dispatches PARTIAL_UPDATE_OFFICIALMESSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OFFICIALMESSAGE actions', async () => {
      const arg = 42666;
