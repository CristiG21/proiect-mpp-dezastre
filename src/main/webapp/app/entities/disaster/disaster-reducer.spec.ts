...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './disaster.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISASTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISASTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISASTER actions', async () => {
      const arg = { id: 12496 };
    ...
    it('dispatches UPDATE_DISASTER actions', async () => {
      const arg = { id: 12496 };
    ...
    it('dispatches PARTIAL_UPDATE_DISASTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISASTER actions', async () => {
      const arg = 42666;
