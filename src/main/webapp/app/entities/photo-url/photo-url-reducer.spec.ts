...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './photo-url.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHOTOURL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PHOTOURL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PHOTOURL actions', async () => {
      const arg = { id: 26408 };
    ...
    it('dispatches UPDATE_PHOTOURL actions', async () => {
      const arg = { id: 26408 };
    ...
    it('dispatches PARTIAL_UPDATE_PHOTOURL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PHOTOURL actions', async () => {
      const arg = 42666;
